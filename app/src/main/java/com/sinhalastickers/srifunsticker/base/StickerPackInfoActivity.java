...
public class StickerPackInfoActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            final Drawable emailDrawable = getResources().getDrawable(R.drawable.ic_email);
        ...
        if (TextUtils.isEmpty(website)) {
            ...
            viewWebpage.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    StickerPackInfoActivity.this.launchWebpage(website);
                }
            });
        }
        ...
        if (TextUtils.isEmpty(email)) {
            ...
            sendEmail.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    StickerPackInfoActivity.this.launchEmailClient(email);
                }
            });
        }
        ...
        if (TextUtils.isEmpty(privacyPolicy)) {
            ...
            viewPrivacyPolicy.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    StickerPackInfoActivity.this.launchWebpage(privacyPolicy);
                }
            });
        }
    }
