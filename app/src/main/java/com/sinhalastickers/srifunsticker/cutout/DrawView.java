...
import static com.sinhalastickers.srifunsticker.cutout.DrawView.DrawViewAction.AUTO_CLEAR;
import static com.sinhalastickers.srifunsticker.cutout.DrawView.DrawViewAction.MANUAL_CLEAR;
import static com.sinhalastickers.srifunsticker.cutout.DrawView.DrawViewAction.ZOOM;
...
class DrawView extends View {
    ...
    public void setButtons(ImageView undoButton, ImageView redoButton) {
    ...
    private void resizeBitmap(int width, int height) {
        if (width > 0 && height > 0 && imageBitmap != null) {
            imageBitmap = ImageManipulation.scale(this.imageBitmap, width, height);
