...
import com.sinhalastickers.srifunsticker.tools.BrushImageView;
import com.sinhalastickers.srifunsticker.tools.TouchImageView;
...
public class ImageEraserActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String s = ıntent.getStringExtra("image_edit_eraser");
    ...
    private void makeHighResolutionOutput() {
        if (this.isImageResized) {
            ...
            Paint paint = new Paint();
            paint.setColor(getResources().getColor(R.color.actionBarArrowColor));
    ...
    public void savePhoto(Bitmap bmp) {
        ...
        File imageFileFolder = new File(Environment.getExternalStorageDirectory(), "eraser");
